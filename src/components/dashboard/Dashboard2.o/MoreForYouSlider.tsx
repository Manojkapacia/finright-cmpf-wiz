    ...
    const cards = [
        {
          ...
          url: `${MESSAGES.api.baseUrl}/proxy/blogs/case-studies/`,
        },
        {
          image: BlogsImage,
          title: "Blogs",
          body: "Understand your PF and know the rules that govern your fund",
          url: `${MESSAGES.api.baseUrl}/proxy/blogs/`,
        },
        // {
        //   image: OurPricingImage,
        //   title: "Our Pricing",
        //   body: "We promise transparent pricing and refund guarantee",
        // //   url: `${MESSAGES.api.baseUrl}/proxy/pricing/`, // will now work
        //  url: "https://finright.in/pricing",
        // },
        {
          image: FinrightNewsImage,
          title: "FinRight in News",
          body: "Our work has been recognised by leading news platforms",
          url: `${MESSAGES.api.baseUrl}/proxy/blogs/finright-in-news/`,
        }
      ];
       
      const isCaseStudies = iframeUrl === `${MESSAGES.api.baseUrl}/proxy/blogs/case-studies/`;
            ...
            {iframeUrl && (
                ...
                >
                    ...
                    <iframe
                        src={iframeUrl}
                        title="More For You"
                       className={isCaseStudies ? "responsive-margin-bottom" : ""}
                        // className="iframe-header-footer-none"
                        style={{ 
                            flexGrow: 1, 
                            border: "none",
                            height: "100%",
                            width: "100%",
                            // marginBottom:iframeUrl === `${MESSAGES.api.baseUrl}/proxy/blogs/case-studies/` ? "-105%" : "0",
