...
const AmountStuckModel = (props: any) => {
  const data = [
    "Amount blocked is total of employer and pension share in the passbooks that have issues.",
    "If you have KYC issues, your entire Provident Fund balance gets blocked.",
  ];
...
export default AmountStuckModel;
