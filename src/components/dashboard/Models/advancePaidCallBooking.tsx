...
import callBackRequestImage from "../../../assets/callbackrequest.png";
import { MdOutlineLocalPolice } from "react-icons/md";

interface AdvancePaidCallBookingProps {
  show: boolean;
  onClose: () => void;
  onBookCall: () => Promise<void>;
}

const AdvancePaidCallBooking: React.FC<AdvancePaidCallBookingProps> = ({
  show,
  onClose,
  onBookCall,
}) => {
              ...
              <center className="px-4">
                ...
                >
                  ...
                  >
                    ...
                    >
                      Schedule<br />with our<br />SPOC for next<br />step
                    </div>
                  </div>

                  {/* Right side: Expert Image */}
                  <img
                    src={callBackRequestImage}
                    alt="Expert"
                    style={{
                      position: "absolute",
                      top: "-17.5%",
...
export default AdvancePaidCallBooking;
