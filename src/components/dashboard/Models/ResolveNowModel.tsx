...
import { TbBeach, TbChartGridDots } from "react-icons/tb";
...
const ResolveNowModel: React.FC<WithdrawTransferNowModelProps> = ({ setShowModal }) => {
  const steps = [
    {
    ...
    {
      text: "Understand issues in your account",
    ...
    },
    {
      ...
      icon: <TbBeach  className="fs-5" style={{ color: "#858585" }} />,
    },
  ];
...
export default ResolveNowModel;
