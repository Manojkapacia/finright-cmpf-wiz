 ...
 const handleToggle = (id: number) => {
  ...
  const zohoUpdateLead = async (tag: string) => {
    ...
    const zohoReqData = {
      ...
      CheckMyPF_Status: existUser
        ? user?.CheckMyPF_Status
        : serviceHistory && !userUan
        ? "API down"
        : "No UAN found",
      CheckMyPF_Intent:
                  ...
                  >
                    <input
                      ...
                      style={{
                        ...
                        MozAppearance: "none",
                        borderRadius: "50%",
                        border: `2px solid ${selectedOptions.includes(option.id) ?"#3687f2": "#858585"}`,
                        backgroundColor: selectedOptions.includes(option.id) ? "#3687f2" : "#FFFFFF",
                    ...
                    <div>
                      <h5 style={{ fontSize: "0.8125rem", fontWeight: 600, margin: 0, }}>
                        {option.heading}
                      </h5>
                      <p style={{ fontSize: "0.8125rem", fontWeight: 400, margin: 0,marginTop:"0.2rem" }}>
                        {option.description}
                      </p>
                    </div>
                  </div>
